...
using DSS2_SynchromodalityCapacityOptimisation.Services.exportSalesForecastDetails.DataContracts;
    ...
    public class exportSalesForecastDetailsService : IexportSalesForecastDetailsService
    {
        public System.Collections.Generic.List<SalesDTO> ExportSalesForecastDetails(string _RequestSourceIp, string _UserName)
        {
            ...
            try
            {
                ...
                var result = Mapper.Map<System.Collections.Generic.List<DSS2_SynchromodalityCapacityOptimisation.BO.Sales>, System.Collections.Generic.List<SalesDTO>>(_exportSalesForecastDetails);
                return result;
            }
        ...
        public static System.Collections.Generic.List<DSS2_SynchromodalityCapacityOptimisation.BO.Sales> ExportSalesForecastDetailsImplementation()
        {
            return new DSS2_SynchromodalityCapacityOptimisation.DAL.Repository().GetAsQueryable<DSS2_SynchromodalityCapacityOptimisation.BO.Sales>()?.Take(500).ToList();
        }
