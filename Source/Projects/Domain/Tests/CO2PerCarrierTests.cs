...
namespace DSS2_SynchromodalityCapacityOptimisation.BoTesting.Tests
{
    ...
    internal class CO2PerCarrierTests : NHibernateFixture
    {
        ...
        public void CO2PerCarrier_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS2_SynchromodalityCapacityOptimisation.BO.CO2PerCarrier>(Session)
        ...
        public void CO2PerCarrier_filtering_test()
        {
            ...
            List<DSS2_SynchromodalityCapacityOptimisation.BO.CO2PerCarrier> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS2_SynchromodalityCapacityOptimisation.BO.CO2PerCarrier>(
                              a => true
