...
namespace DSS2_SynchromodalityCapacityOptimisation.BoTesting.Tests
{
    ...
    internal class AVGTimeTests : NHibernateFixture
    {
        ...
        public void AVGTime_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS2_SynchromodalityCapacityOptimisation.BO.AVGTime>(Session)
        ...
        public void AVGTime_filtering_test()
        {
            ...
            List<DSS2_SynchromodalityCapacityOptimisation.BO.AVGTime> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS2_SynchromodalityCapacityOptimisation.BO.AVGTime>(
                              a => true
