...
using DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ApplicationSettingsList;
...
namespace DSS2_SynchromodalityCapacityOptimisation.UI.Controllers.ApplicationSettingsList
{
    ...
    public class ApplicationSettingsListController : ControllerBase<ApplicationSettingsListViewModel, ApplicationSettingsListViewModelDTO>
    {
        ...
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS2_SynchromodalityCapacityOptimisation.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>().AsQueryable();
            return __items;
        }
