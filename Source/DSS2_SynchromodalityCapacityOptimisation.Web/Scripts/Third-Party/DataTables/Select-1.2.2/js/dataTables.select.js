...
function info ( api )
{
    ...
    var customRowSelection = $(api.table().container()).data["selectedRows"];
    var rows = customRowSelection != undefined ? customRowSelection : api.rows( { selected: true }).flatten().length;
