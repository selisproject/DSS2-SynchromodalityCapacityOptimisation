...
declare module AceAjax {
    ...
    export interface CommandManager {
        ...
        removeCommand(command: EditorCommand);
    ...
    **/
    export interface Ace {
        ...
        **/
        ...
        getSelectionRange();
        toggleCommentLines();
        moveCursorToPosition(pos: { row: number, column: number });
        getSelection();
        findPrevious();
        findNext();
        on(selector: string, cb: Function);
        navigateFileEnd();
        getCursorPosition();
    ...
    **/
    export interface IEditSession {
        ...
        **/
        ...
        foldWidgets: any;
        foldAll(param1: number, param2: number);
    }
    var EditSession: {
        /**
    ...
    **/
    export interface VirtualRenderer {
        ...
        **/
        ...
        setPrintMarginColumn(size: number);
