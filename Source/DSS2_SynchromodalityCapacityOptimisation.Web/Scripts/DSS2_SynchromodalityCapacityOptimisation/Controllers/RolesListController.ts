...
interface Window { scope_RolesList: DSS2_SynchromodalityCapacityOptimisation.Controllers.IRolesListScope; }
...
model:
    DSS2_SynchromodalityCapacityOptimisation.ViewModels.RolesList.RolesListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS2_SynchromodalityCapacityOptimisation.ViewModels.RolesList.RolesListViewModel._lightCast(window.scope_RolesList.model);
    ...
    constructor(private $scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS2_SynchromodalityCapacityOptimisation.ViewModels.RolesList.RolesListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS2_SynchromodalityCapacityOptimisation.ViewModels.RolesList.RolesListViewModel._initializeFrom(window.viewDTO.Model);
