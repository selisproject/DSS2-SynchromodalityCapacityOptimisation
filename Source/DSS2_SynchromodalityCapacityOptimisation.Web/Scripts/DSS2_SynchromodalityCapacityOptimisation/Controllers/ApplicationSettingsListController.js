        ...
        var ApplicationSettingsListController = (function () {
            function ApplicationSettingsListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS2_SynchromodalityCapacityOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
                };
