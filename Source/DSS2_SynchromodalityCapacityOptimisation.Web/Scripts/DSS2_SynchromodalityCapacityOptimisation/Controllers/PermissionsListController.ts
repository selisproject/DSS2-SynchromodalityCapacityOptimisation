...
interface Window { scope_PermissionsList: DSS2_SynchromodalityCapacityOptimisation.Controllers.IPermissionsListScope; }
...
model:
    DSS2_SynchromodalityCapacityOptimisation.ViewModels.PermissionsList.PermissionsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS2_SynchromodalityCapacityOptimisation.ViewModels.PermissionsList.PermissionsListViewModel._lightCast(window.scope_PermissionsList.model);
    ...
    constructor(private $scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS2_SynchromodalityCapacityOptimisation.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS2_SynchromodalityCapacityOptimisation.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom(window.viewDTO.Model);
