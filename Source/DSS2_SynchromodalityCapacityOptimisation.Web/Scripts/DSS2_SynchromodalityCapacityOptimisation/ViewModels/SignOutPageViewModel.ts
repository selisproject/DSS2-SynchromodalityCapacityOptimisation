...
namespace DSS2_SynchromodalityCapacityOptimisation.ViewModels.SignOutPage {
export class SignOutPageViewModel extends DSS2_SynchromodalityCapacityOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
