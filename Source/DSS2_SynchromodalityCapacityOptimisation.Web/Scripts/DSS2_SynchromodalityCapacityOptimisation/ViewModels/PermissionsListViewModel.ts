...
namespace DSS2_SynchromodalityCapacityOptimisation.ViewModels.PermissionsList {
export class PermissionsListViewModel extends DSS2_SynchromodalityCapacityOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
