...
namespace DSS2_SynchromodalityCapacityOptimisation.Web.Code.WebApi
{
    ...
    public class stocksOnHandController : BasicApiCtrl
    {
        ...
        [Route("import")]
        [HttpPost]
        public DSS2_SynchromodalityCapacityOptimisation.Services.stocksOnHand.DataContracts.ResponseDTO Import([FromBody]System.Collections.Generic.List<DSS2_SynchromodalityCapacityOptimisation.Services.stocksOnHand.DataContracts.StockOnHandDTO> stocks)
        {
            ...
            var result =  (new DSS2_SynchromodalityCapacityOptimisation.Services.stocksOnHandService()).Import(stocks,_RequestSourceIp, _UserName);
            return result;
        }
    }
}
