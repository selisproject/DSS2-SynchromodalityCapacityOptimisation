...
namespace DSS2_SynchromodalityCapacityOptimisation.Web.Code.WebApi
{
    ...
    public class exportItemsController : BasicApiCtrl
    {
        ...
        [Route("Export")]
        [HttpGet]
        public System.Collections.Generic.List<DSS2_SynchromodalityCapacityOptimisation.Services.exportItems.DataContracts.ItemDTO> Export()
        {
            ...
            var result =  (new DSS2_SynchromodalityCapacityOptimisation.Services.exportItemsService()).Export(_RequestSourceIp, _UserName);
            return result;
        }
    }
}
