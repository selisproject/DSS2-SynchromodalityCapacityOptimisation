...
namespace DSS2_SynchromodalityCapacityOptimisation.Web.Code.WebApi
{
    ...
    public class exportOFDetailsController : BasicApiCtrl
    {
        ...
        [Route("Export")]
        [HttpGet]
        public System.Collections.Generic.List<DSS2_SynchromodalityCapacityOptimisation.Services.exportOFDetails.DataContracts.OrderForecastDetailsDTO> ExportOFDetails()
        {
            ...
            var result =  (new DSS2_SynchromodalityCapacityOptimisation.Services.exportOFDetailsService()).ExportOFDetails(_RequestSourceIp, _UserName);
            return result;
        }
    }
}
