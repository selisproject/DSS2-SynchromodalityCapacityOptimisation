...
using DSS2_SynchromodalityCapacityOptimisation.UI.Controllers.ManageRole;
using AppCode;
...
namespace DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole
{
    ...
    [OriginalType(typeof(DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel))]
    public class ManageRoleViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel>
    {

        [JsonConstructor]
        public ManageRoleViewModelDTO() { }
        public ManageRoleViewModelDTO(DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel).FullName;
        public List<SelectedItemInfo<int?>> AddPermissionSelectedItemKeys;

        public new DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel();
        }
        new  public DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS2_SynchromodalityCapacityOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel original)
        {
            if (original == null) return;
