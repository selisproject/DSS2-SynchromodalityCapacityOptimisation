! function() {
    if ("ontouchstart" in window) {
        ...
        e = function(e, t) {
            ...
            return s.time = t, s.x = i, s.y = r, (!e.simulated && (500 > n || 1500 > n && a[0] < 50 && a[1] < 50) || f) && (e.preventDefault(), e.stopPropagation(), !f) ? !1 : (f && (window.location = u.getAttribute("href")), void(u && u.classList && (u.classList.add("energize-focus"), window.setTimeout(function() {
...
function(e, t) {
    ...
    function d(e, t, n, i, r) {
        for (var o, s, a, u, l, d, h = t.createDocumentFragment(), p = [], g = 0, m = e.length; m > g; g++)
            if (o = e[g], o || 0 === o)
    ...
    function C(e, t, n, i) {
        ...
        var r, o, s, a, u, l, f = 0,
            ...
            g = t[0],
            m = oe.isFunction(g);
        if (m || h > 1 && "string" == typeof g && !ie.checkClone && Be.test(g)) return e.each(function(r) {
            var o = e.eq(r);
            m && (t[0] = g.call(this, r, o.html())), C(o, t, n, i)
        });
        if (h && (r = d(t, e[0].ownerDocument, !1, e, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (s = oe.map(c(r, "script"), y), a = s.length; h > f; f++) u = r, f !== p && (u = oe.clone(u, !0, !0), a && oe.merge(s, c(u, "script"))), n.call(e[f], u, f);
            if (a)
                for (l = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) u = s[f], He.test(u.type || "") && !Ee.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Ve, "")))
        }
        return e
    }
    ...
    function O(t, n, i) {
        ...
        if (Q.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = k(t, n, s), (0 > o || null == o) && (o = t.style[n]), Qe.test(o)) return o;
    ...
    function D(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (o[s] = Ee.get(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && De(i) && (o[s] = Ee.access(i, "olddisplay", E(i.nodeName)))) : (r = De(i), "none" === n && r || Ee.set(i, "olddisplay", r ? n : oe.css(i, "display"))));
    ...
    function R(e, t, n) {
        var i, r, o = 0,
            ...
            u = function() {
                if (r) return !1;
                for (var t = rt || q(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, o = 1 - i, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
    ...
    var ce =
        ...
        function(e) {
            ...
            function v(e, t, n, r, o, s) {
                return r && !r[R] && (r = v(r)), o && !o[R] && (o = v(o, s)), i(function(i, s, a, u) {
                    var l, c, f, d = [],
                        ...
                        x = n ? o || (i ? e : p || r) ? [] : s : y;
                    if (n && n(y, x, a, u), r)
                        for (l = m(x, h), r(l, [], a, u), c = l.length; c--;)(f = l[c]) && (x[h[c]] = !(y[h[c]] = f));
                    if (i) {
                        if (o || e) {
                            if (o) {
                    ...
                    } else x = m(x === s ? x.splice(p, x.length) : x), o ? o(null, s, x, u) : K.apply(s, x)
                })
            }
                ...
                var r = n.length > 0,
                    ...
                    s = function(i, s, a, u, l) {
                        ...
                        if (h += p, r && p !== h) {
                            ...
                            K.apply(u, v), l && !i && v.length > 0 && h + n.length > 1 && t.uniqueSort(u)
                        }
                        return l && (W = b, A = y), g
                    };
                return r ? i(s) : s
            ...
            w = t.support = {}, T = t.isXML = function(e) {
                ...
                }), w.getElementsByClassName = me.test(D.getElementsByClassName), w.getById = r(function(e) {
                ...
                }, P = [], H = [], (w.qsa = me.test(D.querySelectorAll)) && (r(function(e) {
                ...
                })), (w.matchesSelector = me.test(F = _.matches || _.webkitMatchesSelector || _.mozMatchesSelector || _.oMatchesSelector || _.msMatchesSelector)) && r(function(e) {
                    w.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), P.push("!=", oe)
                }), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), t = me.test(_.compareDocumentPosition), $ = t || me.test(_.contains) ? function(e, t) {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (d = m, f = d[R] || (d[R] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), l = c[e] || [], h = l[0] === W && l[1], x = h && l[2], d = h && m.childNodes[h]; d = ++h && d && d[g] || (x = h = 0) || p.pop();)
                                    ...
                                    for (;
                                        (d = ++h && d && d[g] || (x = h = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && (f = d[R] || (d[R] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), c[e] = [W, x]), d !== t)););
    ...
    oe.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, s, a, u, l, c, f, d, h, p, g, m = Ee.get(e);
            if (m)
        ...
        remove: function(e, t, n, i, r) {
            var o, s, a, u, l, c, f, d, h, p, g, m = Ee.hasData(e) && Ee.get(e);
            if (m && (u = m.events)) {
            ...
            if (a[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                for (s = oe.event.handlers.call(this, e, u), t = 0;
                    ...
                    for (e.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.rnamespace || e.rnamespace.test(o.namespace)) && (e.handleObj = o,
                        e.data = o.data, i = ((oe.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
    ...
    oe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (o = o || c(e), s = s || c(a), i = 0, r = o.length; r > i; i++) b(o[i], s[i]);
                else b(e, a);
    ...
    oe.extend({
        ...
        oe.cssHooks[t] = {
            get: function(e, n, i) {
                return n ? Ze.test(oe.css(e, "display")) && 0 === e.offsetWidth ? Ge(e, et, function() {
                    return O(e, t, i)
                }) : O(e, t, i) : void 0
            },
            set: function(e, n, i) {
        ...
        css: function(e, t) {
            return Se(this, function(e, t, n) {
                var i, r, o = {},
                    s = 0;
                if (oe.isArray(t)) {
                    for (i = Je(e), r = t.length; r > s; s++) o[t[s]] = oe.css(e, t[s], !1, i);
                    return o
                }
    ...
    Nt.href = gt.href, oe.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var l, f, y, x, w, S = n;
                2 !== b && (b = 2, u && e.clearTimeout(u), r = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, i && (x = z(d, C, i)), x = V(d, x, C, l), l ? (d.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = C.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === d.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = x.state, f = x.data, y = x.error, l = !y)) : (y = S, (t || !S) && (S = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n || S) + "", l ? g.resolveWith(h, [f, S, C]) : g.rejectWith(h, [C, S, y]), C.statusCode(v), v = void 0, c && p.trigger(l ? "ajaxSuccess" : "ajaxError", [C, d, l ? f : y]), m.fireWith(h, [C, S]), c && (p.trigger("ajaxComplete", [C, d]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            ...
            if (g.promise(C).complete = m.add, C.success = C.done, C.error = C.fail, d.url = ((t || d.url || gt.href) + "").replace(yt, "").replace(St, gt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = oe.trim(d.dataType || "*").toLowerCase().match(we) || [""], null == d.crossDomain) {
                l = Q.createElement("a");
                try {
    ...
    oe.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Pt, "$1" + r) : t.jsonp !== !1 && (t.url += (vt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
    ...
    oe.fn.load = function(e, t, n) {
        ...
        oe.cssHooks[t] = N(ie.pixelPosition, function(e, n) {
            return n ? (n = k(e, t), Qe.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    }), oe.each({
        Height: "height",
        Width: "width"
...
function(e) {
    ...
    function t(t) {
        if (t && "" !== t) {
            ...
            for (var n = 0; n < u.length; n++) $(".highlight." + u[n]).hide(), $(".lang-specific." + u[n]).hide();
            $(".highlight." + t).show(), $(".lang-specific." + t).show(), e.toc.calculateHeights(), $(window.location.hash).get(0) && $(window.location.hash).get(0).scrollIntoView(!0)
        }
    }
    ...
    function a(e) {
        ...
        u = e;
        var i = r();
        i ? (t(i), localStorage.setItem("language", i)) : t(null !== n && -1 != jQuery.inArray(n, u) ? n : u[0])
    }
    var u = [];
    ...
    e.version = "0.5.7",
        ...
        e.Pipeline = function() {
            ...
            for (var t = [], n = e.length, i = this._stack.length, r = 0; n > r; r++) {
                for (var o = e[r], s = 0; i > s && (o = this._stack[s](o, r, e), void 0 !== o); s++);
                void 0 !== o && t.push(o)
            }
            return t
        ...
        e.SortedSet = function() {
            ...
            var t = t || 0,
                ...
                r = t + Math.floor(i / 2),
                o = this.elements[r];
            return 1 >= i ? o === e ? r : -1 : e > o ? this.indexOf(e, r, n) : o > e ? this.indexOf(e, t, r) : o === e ? r : void 0
            ...
            return e > o ? this.locationFor(e, r, n) : o > e ? this.locationFor(e, t, r) : void 0
        ...
        e.stemmer = function() {
            var e = {
                ...
                L = function(n) {
                    ...
                    if (o = n.substr(0, 1), "y" == o && (n = o.toUpperCase() + n.substr(1)), s = p, a = g, s.test(n) ? n = n.replace(s, "$1$2") : a.test(n) && (n = n.replace(a, "$1$2")), s = m, a = v, s.test(n)) {
                        var L = s.exec(n);
    ...
    function(e) {
        ...
        e.widget("toc.tocify", {
            ...
            _generateToc: function() {
                ...
                return t = -1 !== this.options.selectors.indexOf(",") ? e(this.options.context).find(this.options.selectors.replace(/ /g, "").substr(0, this.options.selectors.indexOf(","))) : e(this.options.context).find(this.options.selectors.replace(/ /g, "")), t.length ? (i.element.addClass(r), void t.each(function(t) {
                    e(this).is(o) || (n = e("<ul/>", {
                        id: u + t,
                        "class": u
            ...
            _appendSubheaders: function(t, n) {
                ...
                s > o ? t.element.find(f + "[data-tag=" + o + "]").last().append(t._nestElements(e(this), i)) : o === s ? n.find(h).last().after(t._nestElements(e(this), i)) : n.find(h).last().after(e("<ul/>", {
                    "class": c,
                    "data-tag": o
            ...
            _setEventHandlers: function() {
                ...
                this.element.on("click.tocify", "li", function(n) {
                    if (r.options.history && (t.location.hash = e(this).attr("data-unique")), r.element.find("." + r.focusClass).removeClass(r.focusClass), e(this).addClass(r.focusClass), r.options.showAndHide) {
                        var i = e('li[data-unique="' + e(this).attr("data-unique") + '"]');
                        r._triggerShow(i)
                    }
                    r._scrollTo(e(this))
                    ...
                    e("html, body").promise().done(function() {
                        ...
                        setTimeout(function() {
                            ...
                            if (r.cachedAnchors.each(function(e) {
                                    return r.cachedHeights[e] - u < 0 ? void(a = e) : !1
            ...
            show: function(t, n) {
                var i = this;
                if (!t.is(":visible")) switch (t.find(f).length || t.parent().is(l) || t.parent().is(":visible") ? t.children(f).length || t.parent().is(l) || (t = t.closest(f)) : t = t.parents(f).add(t), i.options.showEffect) {
                    case "none":
                        t.show();
                        break;
                    case "show":
                ...
                return t.parent().is(l) ? i.hide(e(f).not(t)) : i.hide(e(f).not(t.closest(l).find(f).not(t.siblings()))), i
            },
            hide: function(e) {
                var t = this;
            ...
            _scrollTo: function(t) {
                ...
                return e("html, body").promise().done(function() {
                    e("html, body").animate({
                        scrollTop: e('div[data-unique="' + t.attr("data-unique") + '"]').next().offset().top - (e.isFunction(r) ? r.call() : r) + "px"
                    }, {
                        duration: i
                    })
                }), n
